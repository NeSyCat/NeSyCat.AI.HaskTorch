...
--   per class @{True, False}@) -- pure logits, so @classifierA \@LogVec = LogLeaf [True,False] . mlp@
--   and @classifierA \@Dist = decode . classifierA \@LogVec@, with no logit-padding hack.
mlpArch :: Arch
