-- | Negative-log satisfaction knowledge loss for the @LogVec Bool@ truth object:
...
--   @LogVec Bool@ analogue of 'F_Inferential.Library.Softplus.softplus' (the logit reading's
--   knowledge loss).
...
negLogSat :: LogVec Bool -> Torch.Tensor
