...
module Lib.Example (Example (..), runExample) where

import Data.Kind (Type)
import Lib.E_Inferential.Train (train)
import Lib.F_Statistical.Report (Report, runAverage)
...
class Example e where
  ...
  report :: Params e -> Data e -> IO Report -- predict + label + labeled metrics
