...
module Examples.MnistAddition.F_Statistical (mnistReport) where

import Data.Functor.Identity (runIdentity)
import Examples.MnistAddition.A_Categorical (GeomU)
import Examples.MnistAddition.C_Domain.Interpretation ()
import Examples.MnistAddition.C_Domain.Signature (MnistKlRel (..))
import Examples.MnistAddition.D_Grammatical.InterpretationData (mnistProb)
...
mnistReport :: ParamsCNN -> MnistDataset -> Report
