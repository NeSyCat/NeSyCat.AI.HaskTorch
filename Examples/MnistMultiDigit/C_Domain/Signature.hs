...
--   Kleisli function 'digit' (its monad is @Dist@ or @LogVec@) -- the SAME single-digit classifier, called
...
--   @Dist@ for the probability reading, @LogVec@ for the differentiable one) -- the SAME Kleisli function
