...
module C_Domain.Examples.MnistAddition.Interpretation
  ( module C_Domain.Examples.MnistAddition.Signature,
...
import C_Domain.Examples.MnistAddition.Signature (MnistArith (..), MnistBridge (..), MnistKlRel (..), MnistSorts (..))
